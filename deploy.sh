...
$HISTOMICS_SOURCE_FOLDER/ansible/deploy_docker.py start --build --latest --mount $HISTOMICS_SOURCE_FOLDER:/opt/histomicstk/HistomicsTK/ --mount $HISTOMICS_TESTDATA_FOLDER:/data/ $@
